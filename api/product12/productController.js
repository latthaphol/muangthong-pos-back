...
class productController {
    ...
    async add_product(req, res) {
        try {
            const fields = ["product_name", "product_detail", "product_cost", "product_price", "product_qty", "product_type_id", "unit_id","product_length","product_width",]
    ...
    async return_product(req, res) {
        try {
          ...
          if (!order_id) {
            ...
            const returnResult = await model.return_product(order_id);
