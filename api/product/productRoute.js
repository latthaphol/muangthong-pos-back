...
router.post('/get_receipt/:order_id', controller.get_receipt);
router.post('/get_receiptrefund/:order_id', controller.get_receiptrefund);
...
router.post('/getlotprouduct',controller.get_lot);
router.get('/getlotall',controller.get_lot_all);
